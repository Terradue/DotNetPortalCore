...
INSERT INTO priv (id_type, operation, pos, identifier, name) VALUES
    (11, 'v', 1, 'usr-v', 'User: view'),
    (11, 'V', 2, 'usr-V', 'User: view details'),
    (11, 'c', 3, 'usr-c', 'User: create'),
    (11, 'm', 4, 'usr-m', 'User: change'),
    (11, 'd', 5, 'usr-d', 'User: delete'),
    (12, 'v', 6, 'grp-v', 'Group: view'),
    (12, 'V', 7, 'grp-V', 'Group: view details'),
    (12, 'c', 8, 'grp-v', 'Group: create'),
    (12, 'm', 8, 'grp-m', 'Group: change'),
    (12, 'd', 10, 'grp-d', 'Group: delete'),
    (14, 'v', 15, 'cr-v', 'Computing resource: view'),
    (14, 'V', 20, 'cr-V', 'Computing resource: view details'),
    (14, 'c', 16, 'cr-c', 'Computing resource: create'),
    (14, 'm', 17, 'cr-m', 'Computing resource: change'),
    (14, 'p', 18, 'cr-p', 'Computing resource: make public'),
    (14, 'd', 19, 'cr-d', 'Computing resource: delete'),
    (14, 'a', 21, 'cr-a', 'Computing resource: assign (domain)'),
    (14, 'A', 21, 'cr-A', 'Computing resource: assign (global)'),
    (15, 'v', 15, 'catalogue-v', 'Catalogue: view'),
    (15, 'V', 20, 'catalogue-V', 'Catalogue: view details'),
    (15, 'c', 16, 'catalogue-c', 'Catalogue: create'),
    (15, 'm', 17, 'catalogue-m', 'Catalogue: change'),
    (15, 'p', 18, 'catalogue-p', 'Catalogue: make public'),
    (15, 'd', 19, 'catalogue-d', 'Catalogue: delete'),
    (15, 'a', 21, 'catalogue-a', 'Catalogue: assign (domain)'),
    (15, 'A', 21, 'catalogue-A', 'Catalogue: assign (global)'),
    (16, 'v', 15, 'series-v', 'Series: view'),
    (16, 'V', 20, 'series-V', 'Series: view details'),
    (16, 'c', 16, 'series-c', 'Series: create'),
    (16, 'm', 17, 'series-m', 'Series: change'),
    (16, 'p', 18, 'series-p', 'Series: make public'),
    (16, 'd', 19, 'series-d', 'Series: delete'),
    (16, 'a', 21, 'series-a', 'Series: assign (domain)'),
    (16, 'A', 21, 'series-A', 'Series: assign (global)'),
    (18, 'v', 15, 'pubserver-v', 'Publish server: view'),
    (18, 'V', 20, 'pubserver-V', 'Publish server: view details'),
    (18, 'c', 16, 'pubserver-c', 'Publish server: create'),
    (18, 'm', 17, 'pubserver-m', 'Publish server: change'),
    (18, 'p', 18, 'pubserver-p', 'Publish server: make public'),
    (18, 'd', 19, 'pubserver-d', 'Publish server: delete'),
    (18, 'a', 21, 'pubserver-a', 'Publish server: assign (domain)'),
    (18, 'A', 21, 'pubserver-A', 'Publish server: assign (global)'),
    (19, 'v', 15, 'service-v', 'Processing service: view'),
    (19, 'V', 20, 'service-V', 'Processing service: view details'),
    (19, 'c', 16, 'service-c', 'Processing service: create'),
    (19, 'm', 17, 'service-m', 'Processing service: change'),
    (19, 'p', 18, 'service-p', 'Processing service: make public'),
    (19, 'd', 19, 'service-d', 'Processing service: delete'),
    (19, 'a', 21, 'service-a', 'Processing service: assign (domain)'),
    (19, 'A', 21, 'service-A', 'Processing service: assign (global)'),
    ...
    (25, 'm', 73, 'usr-v', 'Project: change'),
    (25, 'd', 74, 'usr-v', 'Project: delete')
;
-- RESULT
-- CHECKPOINT C-02b
