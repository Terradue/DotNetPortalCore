...
# File:         /admin/user.aspx
# Version:      2.3
# Description:  Provides the administration interface for managing user accounts
#
...
void Page_Load(object sender, EventArgs ea) {
    ...
    try {
        context.Open();
        context.XslFilename = Server.MapPath("/template/xsl/admin/") + "user.xsl";
