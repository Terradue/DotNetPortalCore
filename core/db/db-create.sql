...
INSERT INTO priv (identifier, id_type, operation, pos, name) VALUES
    ('usr-c', 11, 'c', 1, 'User: create'),
    ('usr-s', 11, 's', 2, 'User: search'),
    ('usr-v', 11, 'v', 3, 'User: view'),
    ('usr-m', 11, 'm', 4, 'User: change'),
    ('usr-M', 11, 'M', 5, 'User: manage'),
    ('usr-d', 11, 'd', 6, 'User: delete'),
    ('grp-c', 12, 'c', 7, 'Group: create'),
    ('grp-s', 12, 's', 8, 'User: search'),
    ('grp-v', 12, 'v', 9, 'Group: view'),
    ('grp-m', 12, 'm', 10, 'Group: change'),
    ('grp-M', 12, 'M', 11, 'Group: manage'),
    ('grp-d', 12, 'd', 12, 'Group: delete'),
    ('cr-c', 14, 'c', 13, 'Computing resource: create'),
    ('cr-s', 14, 's', 14, 'Computing resource: search'),
    ('cr-v', 14, 'v', 15, 'Computing resource: view'),
    ('cr-m', 14, 'm', 16, 'Computing resource: change'),
    ('cr-M', 14, 'M', 17, 'Computing resource: manage'),
    ('cr-d', 14, 'd', 18, 'Computing resource: delete'),
    ('catalogue-c', 15, 'c', 19, 'Catalogue: create'),
    ('catalogue-s', 15, 's', 20, 'Catalogue: search'),
    ('catalogue-v', 15, 'v', 21, 'Catalogue: view'),
    ('catalogue-m', 15, 'm', 22, 'Catalogue: change'),
    ('catalogue-M', 15, 'M', 23, 'Catalogue: manage'),
    ...
    ('pubserver-c', 18, 'c', 31, 'Publish server: create'),
    ('pubserver-s', 18, 's', 32, 'Publish server: search'),
    ('pubserver-v', 18, 'v', 33, 'Publish server: view'),
    ('pubserver-m', 18, 'm', 34, 'Publish server: change'),
    ('pubserver-M', 18, 'M', 35, 'Publish server: manage'),
    ('pubserver-d', 18, 'd', 36, 'Publish server: delete'),
    ('service-c', 19, 'c', 37, 'Processing service: create'),
    ('service-s', 19, 's', 38, 'Processing service: search'),
    ('service-v', 19, 'v', 39, 'Processing service: view'),
    ('service-m', 19, 'm', 40, 'Processing service: change'),
    ('service-M', 19, 'M', 41, 'Processing service: manage'),
    ('service-d', 19, 'd', 42, 'Processing service: delete'),
    ('scheduler-M', 20, 'M', 43, 'Scheduler: control'),
    ('task-M', 22, 'M', 44, 'Task: control'),
    ('news-c', NULL, 'c', 45, 'News item: create'),
    ('news-s', NULL, 's', 46, 'News item: search'),
    ('news-v', NULL, 'v', 47, 'News item: view'),
    ('news-m', NULL, 'm', 48, 'News item: change'),
    ('news-d', NULL, 'd', 49, 'News item: delete')
;
-- RESULT
-- CHECKPOINT C-02b
