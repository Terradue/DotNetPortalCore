...
INSERT INTO priv (identifier, id_type, operation, pos, name) VALUES
    ('usr-v', 11, 'v', 1, 'User: view'),
    ('usr-V', 11, 'V', 2, 'User: view details'),
    ('usr-c', 11, 'c', 3, 'User: create'),
    ('usr-m', 11, 'm', 4, 'User: change'),
    ('usr-d', 11, 'd', 5, 'User: delete'),
    ('grp-v', 12, 'v', 6, 'Group: view'),
    ('grp-V', 12, 'V', 7, 'Group: view details'),
    ('grp-c', 12, 'c', 8, 'Group: create'),
    ('grp-m', 12, 'm', 9, 'Group: change'),
    ('grp-d', 12, 'd', 10, 'Group: delete'),
    ('cr-v', 14, 'v', 11, 'Computing resource: view'),
    ('cr-V', 14, 'V', 12, 'Computing resource: view details'),
    ('cr-c', 14, 'c', 13, 'Computing resource: create'),
    ('cr-m', 14, 'm', 14, 'Computing resource: change'),
    ('cr-p', 14, 'p', 15, 'Computing resource: make public'),
    ('cr-d', 14, 'd', 16, 'Computing resource: delete'),
    ('cr-a', 14, 'a', 17, 'Computing resource: assign (domain)'),
    ('cr-A', 14, 'A', 18, 'Computing resource: assign (global)'),
    ('catalogue-v', 15, 'v', 19, 'Catalogue: view'),
    ('catalogue-V', 15, 'V', 20, 'Catalogue: view details'),
    ('catalogue-c', 15, 'c', 21, 'Catalogue: create'),
    ('catalogue-m', 15, 'm', 22, 'Catalogue: change'),
    ('catalogue-p', 15, 'p', 23, 'Catalogue: make public'),
    ('catalogue-d', 15, 'd', 24, 'Catalogue: delete'),
    ('catalogue-a', 15, 'a', 25, 'Catalogue: assign (domain)'),
    ('catalogue-A', 15, 'A', 26, 'Catalogue: assign (global)'),
    ('series-v', 16, 'v', 27, 'Series: view'),
    ('series-V', 16, 'V', 28, 'Series: view details'),
    ('series-c', 16, 'c', 29, 'Series: create'),
    ('series-m', 16, 'm', 30, 'Series: change'),
    ('series-p', 16, 'p', 31, 'Series: make public'),
    ('series-d', 16, 'd', 32, 'Series: delete'),
    ('series-a', 16, 'a', 33, 'Series: assign (domain)'),
    ('series-A', 16, 'A', 34, 'Series: assign (global)'),
    ('pubserver-v', 18, 'v', 15, 'Publish server: view'),
    ('pubserver-V', 18, 'V', 20, 'Publish server: view details'),
    ('pubserver-c', 18, 'c', 16, 'Publish server: create'),
    ('pubserver-m', 18, 'm', 17, 'Publish server: change'),
    ('pubserver-p', 18, 'p', 18, 'Publish server: make public'),
    ('pubserver-d', 18, 'd', 19, 'Publish server: delete'),
    ('pubserver-a', 18, 'a', 21, 'Publish server: assign (domain)'),
    ('pubserver-A', 18, 'A', 21, 'Publish server: assign (global)'),
    ('service-v', 19, 'v', 15, 'Processing service: view'),
    ('service-V', 19, 'V', 20, 'Processing service: view details'),
    ('service-c', 19, 'c', 16, 'Processing service: create'),
    ('service-m', 19, 'm', 17, 'Processing service: change'),
    ('service-p', 19, 'p', 18, 'Processing service: make public'),
    ('service-d', 19, 'd', 19, 'Processing service: delete'),
    ('service-a', 19, 'a', 21, 'Processing service: assign (domain)'),
    ('service-A', 19, 'A', 21, 'Processing service: assign (global)'),
    ('scheduler-u', 20, 'm', 57, 'Scheduler: control'),
    ('task-u', 22, 'm', 58, 'Task: control'),
    ('news-v', NULL, 'v', 59, 'News item: view'),
    ('news-c', NULL, 'c', 60, 'News item: create'),
    ('news-m', NULL, 'm', 61, 'News item: change'),
    ('news-d', NULL, 'd', 62, 'News item: delete')
;
-- RESULT
-- CHECKPOINT C-02b
